...
| Work on the contest | `design/match.md`, `design/disciplines.md`, `openspec/specs/contest-engine/`, `openspec/specs/season-contest/` | world, economy |
| Work on the weekly or season cycle | `design/week.md`, `design/loops.md`, `openspec/specs/week-loop/`, `openspec/specs/season-calendar/`, `openspec/specs/season-contest/`, `openspec/specs/activity-catalog/` | contest engine internals |
